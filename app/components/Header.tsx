  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div 
          ...
          style={{
            ...
            left: mousePos.x - (window.innerWidth < 640 ? 96 : window.innerWidth < 1024 ? 144 : 192),
            top: mousePos.y - (window.innerWidth < 640 ? 96 : window.innerWidth < 1024 ? 144 : 192),
      ...
      <header className="fixed w-full top-0 z-50">
              ...
              <div className="hidden sm:flex flex-col lg:flex-row justify-between items-center space-y-2 lg:space-y-0">
                ...
                <div className="flex items-center gap-3 sm:gap-6">
                  ...
                  <div className="flex gap-2 sm:gap-3">
                    <a href="#" className="group w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg sm:rounded-xl flex items-center justify-center hover:from-blue-500 hover:to-blue-600 transition-all duration-300 hover:scale-110 hover:rotate-12">
                      <Facebook size={12} className="sm:w-4 sm:h-4 text-white group-hover:scale-110 transition-transform" />
                    </a>
                    <a href="#" className="group w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-pink-500 to-purple-600 rounded-lg sm:rounded-xl flex items-center justify-center hover:from-pink-400 hover:to-purple-500 transition-all duration-300 hover:scale-110 hover:rotate-12">
        ...
        {/* Main Navigation with Advanced Glassmorphism - Ultra Responsive */}
          ...
          <div className="relative">
            <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
              <div className="flex items-center justify-between h-16 sm:h-18 lg:h-20 xl:h-24">
                ...
                {/* Ultra Premium Logo - Responsive */}
                <div className="group flex items-center space-x-2 sm:space-x-3 lg:space-x-4 cursor-pointer">
                  <div className="relative">
                  ...
                  <div>
                    <h1 className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-black bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 bg-clip-text text-transparent group-hover:from-orange-600 group-hover:via-red-600 group-hover:to-orange-600 transition-all duration-500">
                      KIRAM PREMIUM
                    </h1>
                ...
                {/* Futuristic Navigation - Desktop Only */}
                ...
                {/* Premium CTA & Mobile Menu - Ultra Responsive */}
