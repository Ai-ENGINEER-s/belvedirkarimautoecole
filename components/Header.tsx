...
const Header: React.FC<HeaderProps> = ({ className = '' }) => {
  ...
  const handleNavClick = (itemId: string, href: string): void => {
    setActiveNav(itemId);
    setIsMenuOpen(false);
    
    // Scroll vers la section si c'est un ancrage
    if (href.startsWith('#')) {
  ...
  const navItems: NavItem[] = [
    ...
    { id: 'formations', label: 'Formations', href: '#services' },
    { id: 'tarifs', label: 'Tarifs', href: '#pricing' },
    { id: 'annexes', label: 'Annexes', href: '#partners' },
            ...
            <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
              <div className="flex items-center justify-between h-16 sm:h-18 lg:h-20 xl:h-24">
                ...
                <div className="flex-shrink-0">
                  <a href="#hero" className="group flex items-center space-x-2 sm:space-x-3 lg:space-x-4 cursor-pointer" onClick={(e) => {
                    e.preventDefault();
